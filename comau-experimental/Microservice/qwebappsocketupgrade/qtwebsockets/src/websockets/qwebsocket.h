...
#include "qtwebsockets/src/websockets/qwebsockets_global.h"
//#include "QtWebSockets/qwebsocketprotocol.h"
#include "qtwebsockets/src/websockets/qwebsocketprotocol.h"
...
class QWEBAPPSOCKETUPGRADE_EXPORT  QWebSocket : public QObject
{
    Q_OBJECT
...
public:
    ...
    QMultiMap<QByteArray, QByteArray> requestParameters() const;
