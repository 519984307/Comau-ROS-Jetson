...
#include "../HttpResponseStatusCode.h"
namespace qtWebApp {
...
class QWEBAPPSOCKETUPGRADE_EXPORT HttpResponse {
...
public:
    ...
    */
    ...
    void setStatus(HttpResponseStatusCode statusCode, QByteArray description = QByteArray()) { setStatus(static_cast<int>(statusCode), description); };
